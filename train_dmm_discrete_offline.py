...
print(f"Accuracy rounded samples pred_z-true_b {mca(pred_z_samples_round, pred_z_samples_round)}")
...
print(f"Confusion matrix pred_z-true_b {cm(pred_z_samples_round, pred_z_samples_round)}")